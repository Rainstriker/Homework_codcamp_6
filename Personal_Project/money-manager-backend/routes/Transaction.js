...
router.post('/add/:account/:category', authentication, transactionControllers.addTransaction);
router.put('/update/:account/:category/:id', authentication, transactionControllers.updateTransaction);
